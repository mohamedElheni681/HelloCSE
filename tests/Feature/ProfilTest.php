...
class ProfilTest extends TestCase
{
    ...
    // Créez un profil sans image initiale
    $profil = Profil::factory()->create();

    // Maintenant, définissez l'image initiale
    $profil->update([
        'image' => "images/profils/{$profil->id}/original.jpg",
    ]);

    // Ajoutez l'image originale pour la tester
    Storage::disk('public')->put("images/profils/{$profil->id}/original.jpg", 'dummy content');

    // Mettez à jour le profil avec une nouvelle image
